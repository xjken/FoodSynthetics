...
### Dataset Access
The Dataset is available for download via [Google Drive](https://drive.google.com/file/d/1Bt5q6X45nx4yWowWiYuTB1J6V5_8RMXj/view?usp=drive_link). The dataset consists of 32,830 balanced samples of real and synthetic food images. The link also provide a split that was used to train various models on the paper.
